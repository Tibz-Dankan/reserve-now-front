...
export const UpdateRoomBasicInfo = (props) => {
  ...
  return (
    <Fragment>
      <form
        ...
        className=" flex-1 w-[100%] h-[50vh] relative text-gray-dark-3"
      >
        <div className="border-b-[1px] border-gray-opacity mb-1 pb-2">
          <h1 className="text-xl font-semibold text-gray-dark-4">Basic Info</h1>
        </div>
        <div
          className="overflow-x-hidden h-[80%] lg:h-[60%] pb-14 lg:pb-4
            grid lg:grid-cols-2"
        >
          <div
          ...
          <div className="flex flex-col items-start justify-center  my-2 space-y-1">
          ...
          <div
            className="flex flex-col items-start justify-center my-2 space-y-1 
              lg:mr-4"
          >
        ...
        <div
          className="border-t-[1px] border-gray-opacity pl-0 p-4 absolute bottom-0 
